...
constrained_mae_colors = sns.color_palette('Set2',desat=0.75)
constrained_attractive_mae_colors = sns.color_palette('Set2',desat=1.00)
...
for i,dset in enumerate(dfs):
    ...
    # don't have to update the color
        ...
        color=constrained_mae_colors[label_colors[icolor]]
        attractive_color=constrained_attractive_mae_colors[label_colors[icolor]]
        ...
        color=mae_colors[label_colors[icolor]]
        attractive_color=attractive_mae_colors[label_colors[icolor]]
        ecolor=color
...
# lc=attractive_mae_colors[1],
m2, = ax.plot([], [], c=attractive_mae_colors[0] , marker='s', markersize=24,
                      fillstyle='left', linestyle='none',lw=2)
mymkstyle = mks.MarkerStyle(marker=u's', fillstyle=u'right')
mymkstyle = 's'
m3 = ax.scatter([],[], s=500, marker=mymkstyle, c=attractive_mae_colors[1],
        edgecolors=attractive_mae_colors[2],hatch=3*'x',lw=2)
## m4, = ax.plot([], [], c=attractive_mae_colors[2] , marker='s', markersize=24,
##                       linestyle='none',lw=2)
m4 = ax.scatter([],[], s=500, marker=mymkstyle, c=attractive_mae_colors[0],
        edgecolors=attractive_mae_colors[2],hatch=3*'x',lw=2)
m5 = ax.scatter([],[], s=500, marker=mymkstyle, c='none',
        edgecolors=attractive_mae_colors[1],lw=4)
m6 = ax.scatter([],[], s=500, marker=mymkstyle, c='none',
        edgecolors=attractive_mae_colors[0],lw=4)
...
ax.set_ylabel(r'Characteristic MAE (kJ mol$^{\mathbf{-1}}$)',fontsize=30,fontweight='bold')
