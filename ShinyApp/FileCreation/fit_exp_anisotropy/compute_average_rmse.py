...
fit_files = ['isotropic_fit_exp_coeffs_unconstrained.out',
                'isotropic_fit_exp_coeffs_constrained.out',
                'anisotropic_fit_exp_coeffs_unconstrained.out',
                'anisotropic_fit_exp_coeffs_constrained.out',
                ## 'ohnanisotropic_fit_exp_coeffs_unconstrained.out',
                ## 'ohnanisotropic_fit_exp_coeffs_constrained.out',
                ## 'fullanisotropic_fit_exp_coeffs_unconstrained.out',
                ## 'fullanisotropic_fit_exp_coeffs_constrained.out',
                    ]
...
components = ['Exchange','Electrostatics','Induction','Dhf','Dispersion','Total Energy']
print_components = ['Exchange','Electrostatics','Induction','Dhf','Dispersion','Total_Energy']
...
for fit_file in fit_files:
    ...
    for component in components:
        ...
        for imon1,mon1 in enumerate(molecules):
            for mon2 in molecules[imon1:]:
                ...
                rms_errors = subprocess.check_output('grep "' + component + ' RMS Error" ' + dir_name + fit_file + " | awk '{print $NF}'", shell=True)
                weighted_rms_errors = subprocess.check_output('grep "' + component + ' Weighted RMS Error" ' + dir_name + fit_file + " | awk '{print $NF}'", shell=True)
                ## rms_errors = subprocess.check_output('grep "' + component + ' RMS Error" ' + dir_name + fit_file + " | awk '{print $4}'", shell=True)
                ## weighted_rms_errors = subprocess.check_output('grep "' + component + ' Weighted RMS Error" ' + dir_name + fit_file + " | awk '{print $5}'", shell=True)
                ...
                weighted_rms_errors = [2625.5*float(i) for i in weighted_rms_errors.split()]


                ## if mon1 == 'acetone' and mon2 == 'chloromethane':
                ##     continue
                ## if mon1 == 'chloromethane' and mon2 == 'ethanol':
                ##     continue
                ## elif mon1 == 'co2' and mon2 == 'dimethyl_ether':
                ##     continue
                ## elif mon1 == 'dimethyl_ether' and mon2 == 'ethanol':
                ##     continue
                ## elif mon1 == 'dimethyl_ether' and mon2 == 'methyl_amine':
                ##     continue
                ## elif mon1 == 'ethanol' and mon2 == 'methyl_amine':
                ##     continue

                #print component, mon1, mon2, rms_errors
    ...
    for line in zip(print_components,rms_geomeans,weighted_rms_geomeans):
